...
typedef enum { ROLE_INVALID, ROLE_MASTER_ANCHOR, ROLE_SLAVE_ANCHOR, ROLE_TAG } instance_role_t;

#define IDENTITY_ADDRESS_INVALID 0xFFFE
#define IDENTITY_ADDRESS_BROADCAST 0xFFFF

#define IDENTITY_OPERATIONS_NONE						0x0000
//#define IDENTITY_OPERATIONS_TIMESYNC_MASTER				0x0001
#define IDENTITY_OPERATIONS_TIMESYNC_SLAVE				0x0002
#define IDENTITY_OPERATIONS_RANGING_MASTER				0x0004
#define IDENTITY_OPERATIONS_RANGING_SLAVE				0x0008
#define IDENTITY_OPERATIONS_BLINK_TX					0x0010
#define IDENTITY_OPERATIONS_BLINK_RX					0x0020
...
#define IDENTITY_OPERATIONS_ALL_UWB_RX					(IDENTITY_OPERATIONS_TIMESYNC_SLAVE|IDENTITY_OPERATIONS_RANGING_MASTER|IDENTITY_OPERATIONS_RANGING_SLAVE|IDENTITY_OPERATIONS_BLINK_RX|IDENTITY_OPERATIONS_MONITOR | IDENTITY_OPERATIONS_DATA_RX)
