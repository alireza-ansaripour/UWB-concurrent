...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  HAL_PCDEx_PMAConfig(&PCD_Handle , 0x00 , PCD_SNG_BUF, 0x18);
  HAL_PCDEx_PMAConfig(&PCD_Handle , 0x80 , PCD_SNG_BUF, 0x58);
  HAL_PCDEx_PMAConfig(&PCD_Handle , 0x81 , PCD_SNG_BUF, 0x100);
